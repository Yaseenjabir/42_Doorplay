const Subscribe = () => {
  return (
    <>
      <section className="w-full mt-10 lg:mt-20 py-14 lg:py-16 bg-darkRed text-white px-2 flex flex-col gap-10 items-center justify-center lg:flex-row max-w-[1150px] mx-auto lg:justify-evenly lg:w-[85%] lg:gap-64">
