...
const DoorplayDifference = () => {
  ...
  return (
    <>
      <section className="mt-20 lg:mt-40 bg-lightGray flex flex-col items-center py-20 text-center lg:text-start px-5 w-full lg:px-14 lg:py-48">
        <h1 className="text-2xl font-semibold lg:text-[30px] text-titleColor text-center">
          The A&R Difference
        </h1>
        <div className="flex flex-col w-full my-7 lg:my-10 gap-10 lg:flex-row lg:gap-8">
          <div className={styles}>
            <AiOutlineDashboard className="text-5xl group-hover:text-[#f1ab92] lg:self-start" />
            <h1 className="text-2xl font-bold group-hover:text-[#f1ab92] w-full">
          ...
          <div className="flex group flex-col items-center justify-center py-12 lg:w-[32%] pb-[100px] gap-8 bg-darkRed rounded-xl text-white px-8 hover:bg-white transition-all ease-in-out duration-300 cursor-pointer">
            <RiUserStarLine className="text-5xl text-[#f1ab92] group-hover:text-titleColor lg:self-start" />
            <h1 className="text-2xl font-bold text-[#f1ab92] group-hover:text-titleColor w-full">
              Expert Guidance
            </h1>
          ...
          <div className={styles}>
            <PiPencilLine className="text-5xl group-hover:text-[#f1ab92] lg:self-start" />
            <h1 className="text-2xl font-bold group-hover:text-[#f1ab92] w-full">
