  ...
  return (
    <>
      <section
        ...
        id="heroSection"
        className="h-[calc(100vh-106px)] flex items-center px-5 lg:px-8 text-white relative w-full before:content-[''] before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-[#00000070]"
      >
